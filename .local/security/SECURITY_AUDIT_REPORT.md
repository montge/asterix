...
**Location:** `/path/to/asterix/.github/dependabot.yml`
...
**Location:** `/path/to/asterix/SECURITY.md`
...
**File:** `/path/to/asterix/.github/workflows/ci-verification.yml`
...
**File:** `/path/to/asterix/.github/workflows/nightly-builds.yml`
...
**File:** `/path/to/asterix/.github/workflows/build-packages.yml`
