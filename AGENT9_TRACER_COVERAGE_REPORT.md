...
### Test File Created
- **Location:** `/path/to/asterix/tests/cpp/test_tracer.cpp`
...
Updated `/path/to/asterix/tests/cpp/CMakeLists.txt` with:
...
### gcov Output
```
File '/path/to/asterix/src/asterix/Tracer.cpp'
...
### Created
- `/path/to/asterix/tests/cpp/test_tracer.cpp` (21 tests, 379 lines)

### Modified  
- `/path/to/asterix/tests/cpp/CMakeLists.txt` (added test_tracer target)
