...
**Location:** `/path/to/asterix/src/asterix/Category.cpp:50-55`
```cpp
...
**Location:** `/path/to/asterix/src/asterix/DataItemFormatFixed.cpp:176-181`
```cpp
...
**Location:** `/path/to/asterix/src/asterix/DataRecord.cpp:211-233`
```cpp
...
**Location:** `/path/to/asterix/src/asterix/Utils.cpp:26-36`
```cpp
...
**Location:** `/path/to/asterix/src/asterix/DataItemFormat.h:57-67`
```cpp
...
**Location:** `/path/to/asterix/src/asterix/DataItemFormat.h:45-46`
```cpp
...
**Location:** `/path/to/asterix/src/asterix/InputParser.cpp:58-102`
```cpp
#ifdef _DEBUG
...
**Location:** `/path/to/asterix/src/asterix/Tracer.cpp:34-39`
```cpp
...
**Also applies to:** `/path/to/asterix/src/engine/singleton.hxx`
...
**Locations:**
- `/path/to/asterix/src/asterix/InputParser.cpp` (7 occurrences)
- `/path/to/asterix/src/asterix/asterixgpssubformat.cxx` (1 occurrence)
...
**Location:** `/path/to/asterix/src/asterix/Utils.cpp:27`
```cpp
...
**Location:** `/path/to/asterix/src/asterix/DataRecord.cpp:56`
```cpp
...
**Example:** `/path/to/asterix/src/asterix/DataRecord.cpp:212-233`
```cpp
for (auto* di : m_lDataItems) {
    if (di->getText(strNewResult, strHeader, formatType)) {
        switch (formatType) {
