...
#### New Files Created:
1. `/path/to/asterix/src/asterix/cxx23_features.h` - Feature detection header

#### Modified Header Files:
2. `/path/to/asterix/src/asterix/DataItemFormat.h` (Lines 28, 60-67)
3. `/path/to/asterix/src/asterix/DataItemFormatFixed.h` (Lines 29, 42-47)
4. `/path/to/asterix/src/asterix/DataItemFormatVariable.h` (Lines 29, 40-45)
5. `/path/to/asterix/src/asterix/DataItemFormatCompound.h` (Lines 29, 40-45)
6. `/path/to/asterix/src/asterix/DataItemFormatRepetitive.h` (Lines 28, 39-44)
7. `/path/to/asterix/src/asterix/DataItemFormatExplicit.h` (Lines 29, 40-45)
8. `/path/to/asterix/src/asterix/DataItemFormatBDS.h` (Lines 28, 39-44)

#### Modified Implementation Files:
9. `/path/to/asterix/src/asterix/DataItemFormat.cpp` (Lines 37-51) - Destructor
10. `/path/to/asterix/src/asterix/DataItemFormatVariable.cpp` (Lines 32-53) - Copy constructor
11. `/path/to/asterix/src/asterix/DataItemFormatCompound.cpp` (Lines 32-53) - Copy constructor

#### Build System:
12. `/path/to/asterix/src/makefile.include` (Lines 75-77) - C++23 standard flag
...
**File:** `/path/to/asterix/src/asterix/DataItemFormatVariable.cpp`
**Lines:** 32-53
...
**File:** `/path/to/asterix/src/asterix/DataItemFormat.cpp`
**Lines:** 37-51
...
**File:** `/path/to/asterix/src/asterix/cxx23_features.h`
...
**Test Suite:** `/path/to/asterix/install/test/test.sh`
**Total Tests:** 12
**Passed:** 12
**Failed:** 0
**Success Rate:** 100%
