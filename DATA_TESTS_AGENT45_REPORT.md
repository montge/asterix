...
**File Location:** `/path/to/asterix/src/asterix/AsterixData.cpp`
...
**File Location:** `/path/to/asterix/src/asterix/DataItemDescription.cpp`
...
**File:** `/path/to/asterix/tests/cpp/test_asterixdata.cpp`
**Test Cases:** 18
**Lines of Code:** 633
**Pass Rate:** 100%
...
**File:** `/path/to/asterix/tests/cpp/test_dataitemdescription.cpp`
**Test Cases:** 27
**Lines of Code:** 420
**Pass Rate:** 100%
...
**File:** `/path/to/asterix/tests/cpp/CMakeLists.txt`
...
1. `/path/to/asterix/tests/cpp/test_asterixdata.cpp` (633 lines)
2. `/path/to/asterix/tests/cpp/test_dataitemdescription.cpp` (420 lines)
3. `/path/to/asterix/DATA_TESTS_AGENT45_REPORT.md` (this file)
