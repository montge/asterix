...
**File:** `/path/to/asterix/src/asterix/DataItemFormatRepetitive.cpp:55`
**Severity:** CRITICAL
...
**File:** `/path/to/asterix/src/asterix/asterixhdlcparsing.c:387`
**Severity:** CRITICAL
...
**File:** `/path/to/asterix/src/asterix/wireshark-plugin/1.10.6/plugins/asterix/packet-asterix.c:113-122`
**Severity:** HIGH
...
**File:** `/path/to/asterix/src/asterix/InputParser.cpp:72-82`
**Severity:** HIGH
...
**File:** `/path/to/asterix/src/asterix/asterixrawsubformat.cxx:73-86`
**Severity:** HIGH
**CWE:** CWE-190 (Integer Overflow)
...
**File:** `/path/to/asterix/src/asterix/DataItemFormatVariable.cpp:62-77`
**Severity:** HIGH
...
**File:** `/path/to/asterix/src/asterix/asterixhdlcparsing.c:94-96`
**Severity:** HIGH
...
**File:** `/path/to/asterix/src/asterix/DataRecord.cpp:74-80`
**Severity:** HIGH
...
- `/path/to/asterix/src/asterix/DataItemBits.cpp:912`
- `/path/to/asterix/src/asterix/WiresharkWrapper.cpp:113,187,209,230,246,256,278,300,320`
...
**File:** `/path/to/asterix/src/asterix/asterixpcapsubformat.cxx:116-125`
**Severity:** HIGH
...
**File:** `/path/to/asterix/src/asterix/DataRecord.cpp:46-72`
**Severity:** MEDIUM
**CWE:** CWE-835 (Loop with Unreachable Exit Condition)
...
**File:** `/path/to/asterix/src/asterix/DataItemBits.cpp:107-109`
**Severity:** MEDIUM
...
**File:** `/path/to/asterix/src/asterix/DataRecord.cpp:92-127`
**Severity:** MEDIUM
...
**File:** `/path/to/asterix/src/asterix/DataItemBits.cpp:210,217,257,264,287,302,356,362,406`
**Severity:** MEDIUM
**CWE:** CWE-252 (Unchecked Return Value)
...
**File:** `/path/to/asterix/src/asterix/DataItemFormatCompound.cpp:64-91`
**Severity:** MEDIUM
**CWE:** CWE-823 (Use of Out-of-Range Pointer Offset)
...
**File:** `/path/to/asterix/src/asterix/DataItemBits.cpp:479-489`
**Severity:** LOW
...
**File:** `/path/to/asterix/src/python/python_parser.cpp:49`
**Severity:** LOW
**CWE:** CWE-120
...
**File:** `/path/to/asterix/src/python/python_wrapper.c:111-125`
**Severity:** LOW
...
**File:** `/path/to/asterix/src/engine/udpdevice.cxx:152-193`
**Severity:** MEDIUM
**CWE:** CWE-400 (Uncontrolled Resource Consumption)
...
**File:** XML parsing in `/path/to/asterix/src/asterix/XMLParser.cpp`
**Severity:** MEDIUM
