...
CMAKE_SOURCE_DIR = /path/to/asterix/_deps/googletest-subbuild

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /path/to/asterix/_deps/googletest-subbuild
...
CMakeFiles/googletest-populate-complete: googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/path/to/asterix/_deps/googletest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'googletest-populate'"
	/usr/bin/cmake -E make_directory /path/to/asterix/_deps/googletest-subbuild/CMakeFiles
	/usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/CMakeFiles/googletest-populate-complete
	/usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-done
...
googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-build: googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/path/to/asterix/_deps/googletest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "No build step for 'googletest-populate'"
	cd /path/to/asterix/_deps/googletest-build && /usr/bin/cmake -E echo_append
	cd /path/to/asterix/_deps/googletest-build && /usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-build
...
googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-configure: googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/path/to/asterix/_deps/googletest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "No configure step for 'googletest-populate'"
	cd /path/to/asterix/_deps/googletest-build && /usr/bin/cmake -E echo_append
	cd /path/to/asterix/_deps/googletest-build && /usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-configure
...
googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-download: googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/path/to/asterix/_deps/googletest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Performing download step (download, verify and extract) for 'googletest-populate'"
	cd /path/to/asterix/_deps && /usr/bin/cmake -P /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/download-googletest-populate.cmake
	cd /path/to/asterix/_deps && /usr/bin/cmake -P /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/verify-googletest-populate.cmake
	cd /path/to/asterix/_deps && /usr/bin/cmake -P /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/extract-googletest-populate.cmake
	cd /path/to/asterix/_deps && /usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-download
...
googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-install: googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/path/to/asterix/_deps/googletest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'googletest-populate'"
	cd /path/to/asterix/_deps/googletest-build && /usr/bin/cmake -E echo_append
	cd /path/to/asterix/_deps/googletest-build && /usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-install

googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/path/to/asterix/_deps/googletest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'googletest-populate'"
	/usr/bin/cmake -Dcfgdir= -P /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/tmp/googletest-populate-mkdirs.cmake
	/usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-mkdir
...
googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-patch: googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/path/to/asterix/_deps/googletest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'googletest-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-patch
...
googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-test: googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/path/to/asterix/_deps/googletest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No test step for 'googletest-populate'"
	cd /path/to/asterix/_deps/googletest-build && /usr/bin/cmake -E echo_append
	cd /path/to/asterix/_deps/googletest-build && /usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-test
...
googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-update: googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/path/to/asterix/_deps/googletest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "No update step for 'googletest-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /path/to/asterix/_deps/googletest-subbuild/googletest-populate-prefix/src/googletest-populate-stamp/googletest-populate-update
...
CMakeFiles/googletest-populate.dir/depend:
	cd /path/to/asterix/_deps/googletest-subbuild && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /path/to/asterix/_deps/googletest-subbuild /path/to/asterix/_deps/googletest-subbuild /path/to/asterix/_deps/googletest-subbuild /path/to/asterix/_deps/googletest-subbuild /path/to/asterix/_deps/googletest-subbuild/CMakeFiles/googletest-populate.dir/DependInfo.cmake "--color=$(COLOR)"
